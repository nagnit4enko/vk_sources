...
Payments.adsConfirmGoPaymentSystem = function(func) {
  ...
  var confirmBox = showFastBox('��������', confirmMessage, getLang('payments_payment_system_submit'), function() { func(); confirmBox.hide(); }, getLang('box_close'));
}
    ...
    if (btn) {
      ...
      cur.userAutoScroll = new AutoList(tbl, {
        ...
        onNeedRows: function(cb, offset) {
          ajax.post('al_payments.php', { act: 'money_transfer_history_box', offset: offset, owner_id: oid }, {
            onDone: cb
          });
        },
