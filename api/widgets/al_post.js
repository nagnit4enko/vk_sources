var WPost = {
  ...
  unsubscribe: function(el, oid, hash) {
    var doUnsubscribe = function() {
      var oldHTML = el.innerHTML, oldOnclick = el.onclick;
      if (cur.options.templates) {
      ...
      ajax.post('widget_post.php', {act: 'unsubscribe', oid: oid, hash: hash}, {
        onFail: function(msg) {
        ...
        extend(window, {
          ...
          showWiki: function(likeInfo) {
            ...
            if (likeInfo[0] == 'likes') {
              ...
              WPost.showLikesBox(likeInfo[1], {tab: 'published'});
            } else {
              return true;
            }
          },
          ...
          mentionOver: function(el, opts) {
            showTooltip(el, {
              url: 'al_wall.php',
              params: {act: 'mention_tt', mention: el.getAttribute('mention_id'), from: 'wpost'},
              shift: [12, 7, 7],
              hidedt: 500,
              showdt: 500,
              slide: 15,
...
try{stManager.done('api/widgets/al_post.js');}catch(e){}
