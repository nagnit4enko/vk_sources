var DotaLanding = {
    ...
    subscribe: function(btn, hash, group_id, unsubscribe) {
        ...
        ajax.post('al_public.php', { act: act, hash: hash, pid: group_id, gid: group_id}, {
    ...
    showVideo: function(video_id, autoplay_enabled) {
        ...
        hide(oldVideo);
        show(container);
        showInlineVideo(video_id, '', {autoplay: autoplay_enabled}, false, container);
    },
...
dotaLanding = DotaLanding;try{stManager.done('dota_landing.js');}catch(e){}
